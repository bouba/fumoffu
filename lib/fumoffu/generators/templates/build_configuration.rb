configuration do |c|
  ...
  # default value: []
  #
  c.java_lib_files = ["engine/lib/java/generated/bundled_gems.jar", "interface/lib/jruby-complete.jar", "interface/lib/SwingLayout.jar", "interface/lib/AbsoluteLayout.jar"]                                                         
